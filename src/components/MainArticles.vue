      ...
      "articlesText": [
...

        {
          ...
          title: "Пеликаны впервые после зимы вышли на пруд в Московском зоопарке"
				...
				{
          id: "7",
          title: "В хабаровском зоосаде леопард-долгожитель справил 17-летие"
        },

        {
          id: "8",
          title: "На севере Приморья обнаружили спасенного ранее тигра без клыка"
        },

        {
          id: "9",
          title: "В Центре восстановления леопарда на Кавказе родился детенышy"
        },
      ]
    }
  }
